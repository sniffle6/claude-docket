...
This will:
1. Build the docket binary to `~/.local/share/docket/docket.exe`
2. Install the Claude Code plugin to `~/.claude/plugins/cache/local/docket/0.1.0/`
...
Re-run `bash install.sh` after pulling changes. It overwrites the docket binary and plugin files.
